...
class FavoriteMovieSlider extends StatefulWidget {
  const FavoriteMovieSlider({Key? key, required this.movies, this.title, required this.onNextPage}) : super(key: key);
  ...
  @override
  State<FavoriteMovieSlider> createState() => _FavoriteMovieSliderState();
}

class _FavoriteMovieSliderState extends State<FavoriteMovieSlider> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: GestureDetector(
        onTap: () => Navigator.pushNamed(context, DetailsScreen.routeName, arguments: movie).then((value) => Navigator.pop(context)),
        child: Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Hero(
